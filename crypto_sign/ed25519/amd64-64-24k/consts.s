#ifdef __APPLE__
  #define BITZUM_LOCAL_SYMBOL(x) .private_extern x
#else
  #define BITZUM_LOCAL_SYMBOL(x) .hidden x
#endif
...
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_121666)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU0)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU1)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU2)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU3)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU4)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER0)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER1)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER2)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER3)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D0)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D1)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D2)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D3)
BITZUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_38)
